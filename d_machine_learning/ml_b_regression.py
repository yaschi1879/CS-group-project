...
for player in player_list:
    ...
    player_data.append(player_dict[0])
    player_data_log.append(player_dict[1])
    time.sleep(1)

data_frame = pd.DataFrame(player_data)
data_frame_log = pd.DataFrame(player_data_log)
# --------------------------------------------------------------------------------
# jetzt kommt die erstellung der regression für normal und log
...
# Analyse von Ausreißern (Cook's Distance)
...
# Identifikation von potenziellen Ausreißern
...
# Entferne Ausreißer und refitte das Modell
if len(outliers) > 0:
...
# ----------------------------------------------------------------------------------------------------
# jetzt kommt die erstellung eines random forests für normal
